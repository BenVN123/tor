...
// This function generates public and private keys, then stores them in the
// structures you provide pointers to. The 3rd argument should be the text
...
// This function will decrypt the data pointed to by message. It returns a
